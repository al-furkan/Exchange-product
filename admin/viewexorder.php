...
<div class="container">
    <div class="divTable div-hover">
            ...
            <?php  
              ...
              $get_w = "SELECT * FROM extraorder order by id desc";
              $run_w = mysqli_query($con, $get_w);
        
              while($row_w=mysqli_fetch_array($run_w)){
               $id = $row_w['id'];
               $casname = $row_w['cname'];
               $casphone = $row_w['cphone'];
               $casaddress = $row_w['caddress'];            
               $proname = $row_w['pname'];
               $prodiscript = $row_w['pdetails'];
               $img1 = $row_w['pimg'];
               $proprice = $row_w['pprize'];
            ...
            <div class="rowTable">
                <div class="divTableCol">
                    <div class="media">
                        <a class=" pull-left mr-2 ml-0" href="#"><img width = "100px"   height="120px" class="img-fluid" src="../uploads/<?php echo $img1;?>" /></a>
                        <div class="media-body">
                            <h4 class="media-heading"><a href="#"><?php echo $proname ;?></a></h4>
                            <h5 class="media-heading"> Price:<?php echo  $proprice;?> <a href="#">Details</a>
                             </h5>Details:  <i> </i>  <b><?php echo $prodiscript ;?> </b>
                ...
                <div class="divTableCol">
                <div class="divTableCol"><strong></strong></div>
                </div>
                <div class="divTableCol"><strong><?php echo $casphone ;?></strong></div>
                <div class="divTableCol"><strong><?php echo $casaddress ;?></strong></div>
                <div class="divTableCol">
                    <a href="removeorder.php?rmproduct=<?php echo $id; ?>"><button type="button" class="btn btn-danger"><span class="fa fa-remove"></span> Remove</button></a>
                </div>
            </div>
